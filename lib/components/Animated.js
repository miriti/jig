define([
  ...
  Animated.prototype.moveTo = function(x, y, totalTime, easing) {
    return this.addAnimation(new MoveTo(x, y, totalTime, easing));
  };
  
  Animated.prototype.animAlpha = function(from, to, totalTime, easing) {
    return this.addAnimation(new Alpha(from, to, totalTime, easing));
  };
  
  Animated.prototype.rotateTo = function(to, totalTime, easing) {
    return this.addAnimation(new RotateTo(to, totalTime, easing));
  };
  
  Animated.prototype.scaleTo = function(to, totalTime, easing) {
    return this.addAnimation(new ScaleTo(to, totalTime, easing));
  };
